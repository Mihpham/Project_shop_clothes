...
<main>
  ...
  $sql_trang = mysqli_query($sql,'select * from product join category where product.id_category=category.id and category.name like "%Hoodie%" ');
  ...
  <ul class="pagination">
    ...
    <li class="page-item">
      <a class="page-link" href="thucdon.php?id_category=1&trang=<?php echo $i ?>"><?php echo $i ?></a>
    </li>
  
    <?php
  }}

  elseif(isset($_GET['id_category']) && ($_GET['id_category'])==2){
    
      $sql_trang = mysqli_query($sql,'select * from product join category where product.id_category=category.id and category.name like "%T-shirt%" ');
      $row_count = mysqli_num_rows($sql_trang);
      $trang = ceil($row_count/4);
  ...
  <ul class="pagination">
    ...
    <li class="page-item">
      <a class="page-link" href="thucdon.php?id_category=2&trang=<?php echo $i ?>"><?php echo $i ?></a>
    </li>
    <?php
    }}
    ?>
