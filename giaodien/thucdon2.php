...
?>
<?php require_once('../database/dbper.php') ?>
<head>
    <meta charset="UTF-8">
...
<header>
  ...
  <div id="menu" style="margin-top:10px;">
    <ul>
      ...
      <li>
        <a href="#" class="bottom">Bottom</a><!--Bottom -->
        <ul class="sub-menu">
      ...
      <li>
        <a href="#" class="collection">Collection</a><!--Collection -->
        <ul class="sub-menu">
          <li>
          <?php
...
<main>
      ...
      <section class="recently">
        ...
        <div class="product-recently">
          <div class="row">
            ...
            $sql = "select * from product,report where id_category=  $id_category AND product.id=report.id_report ORDER BY product.id DESC LIMIT $begin,3";
  ...
  if (isset($_GET['id_category']) && ($_GET['id_category']) == 3) {
    $sql_trang = mysqli_query($sql, 'select * from product join category where product.id_category=category.id and category.name like "%Trouser%" ');
    ...
    <nav aria-label="Page navigation example">
      <ul class="pagination">
        ...
        ?>
          ...
          <li class="page-item">
            <a class="page-link" href="thucdon2.php?id_category=3&trang=<?php echo $i ?>"><?php echo $i ?></a>
          </li>

        <?php
        }
      } elseif (isset($_GET['id_category']) && ($_GET['id_category']) == 4) {

        $sql_trang = mysqli_query($sql, 'select * from product join category where product.id_category=category.id and category.name like "%Short%" ');
        $row_count = mysqli_num_rows($sql_trang);
        $trang = ceil($row_count / 4);
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination">
            ...
            ?>
              ...
              <li class="page-item">
                <a class="page-link" href="thucdon2.php?id_category=4&trang=<?php echo $i ?>"><?php echo $i ?></a>
              </li>
          <?php
            }
          }
