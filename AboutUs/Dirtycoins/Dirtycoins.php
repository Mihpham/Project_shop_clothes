...
<ul id="list-new">
    ...
    <div class="box-left" >
        <a href="/Project_shop_clothes/AboutUs/7 TIPS PHỐI ĐỒ VỚI VARSITY JACKET/7 TIPS PHỐI ĐỒ VỚI VARSITY JACKET.php"><button>Xem thêm </button><!--nút mua hàng --></a>
    </div>   
    ...
    <div class="box-left" >
        <a href="/Project_shop_clothes/AboutUs/THÔNG TIN CHƯƠNG TRÌNH/THÔNG TIN CHƯƠNG TRÌNH.php"><button>Xem thêm </button><!--nút mua hàng --></a>
    </div>       
</ul>
</html>
