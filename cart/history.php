                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="padding: 1rem 0;">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link active" href="/pri">Lịch sử mua hàng</a>
                                </li>
                            </ul>
...
if (isset($_SESSION['username'])) {
    ...
    foreach ($user as $item) {
        ...
        $sql = "SELECT * from order_details, product where product.id=order_details.product_id AND order_details.user_id = '$userId' ORDER BY order_id DESC";
